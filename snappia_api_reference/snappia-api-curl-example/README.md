...
```bash
jq '.medical_coding_result.icd'   response.json
jq '.medical_coding_result.cpt'   response.json
jq '.medical_coding_result.hcpcs' response.json
jq '.medical_coding_result.pcs'   response.json

jq '.medical_coding_result.linkage.icd_cpt_linkage'   response.json
jq '.medical_coding_result.linkage.icd_hcpcs_linkage' response.json
jq '.medical_coding_result.linkage.icd_pcs_linkage'   response.json
```
