...
hcpcs_result = result["medical_coding_result"]["hcpcs"]
pcs_result   = result["medical_coding_result"]["pcs"]

icd_cpt_linkage   = result["medical_coding_result"]["linkage"]["icd_cpt_linkage"]
icd_hcpcs_linkage = result["medical_coding_result"]["linkage"]["icd_hcpcs_linkage"]
icd_pcs_linkage   = result["medical_coding_result"]["linkage"]["icd_pcs_linkage"]
```
